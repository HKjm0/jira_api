...
from django.contrib.auth.models import User  # djangoのUserを利用
from django.core.validators import MinValueValidator  # djangoのValidatorを利用
import uuid  # 128ビットのユニークな値を作ってくれる
